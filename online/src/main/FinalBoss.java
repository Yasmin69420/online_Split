...
// if fought
            ...
            switch (choice){
                ...
                case "h":
                    ...
                    tempHealthHuman = human.getHealth() + 10;
                    human.setHealth((tempHealthHuman));
                    System.out.printf("The %s combats your healing\n", Boss.getName());
                    monsterAttackRoll = diceRoll.nextInt(13); //attack results in loss of some health
                ...
                case "f":
                    ...
                    humanAttackroll = diceRoll.nextInt(33); //roll from 0-3
                    ...
                    monsterAttackRoll = diceRoll.nextInt(29);
