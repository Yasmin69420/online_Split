...
public class CampfireFight {
    ...
    public static void StartCampfireFight(){
        System.out.println("Grunt 1: so wheres your gun?");
        System.out.println("Grunt 2: I thought you had it- HOLY SMOKES");
...
//option to fight
        while(fightOn){
            System.out.println("What would you like to do Tips: Using the gun can do massive amount of damage due to the grunt's lack of armour");
...
// if fought
            switch (choice){
                ...
                case "d":
                    ...
                    System.out.printf("%s Dodges the Grunts attacks\n", human.getName());
