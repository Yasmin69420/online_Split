...
// if fought
            ...
            switch (choice) {
                ...
                case "b":
                    ...
                    shopBackPack.viewBackpack();

                    System.out.println("Which item would you like to use?");
                    String itemChoice = myinput.nextLine().toLowerCase();


                        case "ak-47":
                            System.out.printf("You attempt to shoot the %s\n. She may be immune but the blindess effectfully hurts her ", MiniBoss.getName());
                            humanAttackroll = diceRoll.nextInt(39); //shoots roll from 0-39
                            if (humanAttackroll <= 0) {
                                System.out.printf("You failed to hit the %s\n", MiniBoss.getName());
                                System.out.println("Ugh you and your stupid guns...");
                            ...
                            monsterAttackRoll = diceRoll.nextInt(23);
