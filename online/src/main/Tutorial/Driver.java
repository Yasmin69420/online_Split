...
//Location: Takes place in the first level -> abandoned village
public class Driver {
    ...
    public static void main (String[] args){
        System.out.println("--As you go through the abandoned village you encounter a grunt who doesnt seem pleased with your arrival--");
    ...
    public static void charCreate() {
        ...
        System.out.println("WHATS YOUR NAME ANYWAY");
...
// if fought
            switch (choice){
                case "f":
                    ...
                    if(monster.getHealth() <=0){
                        ...
                        System.out.println("==Your attack stats increased by 6==");
                        gameRunning = false;
                    }
                ...
                case "r":
                    ...
                    if (flee){
                        System.out.println("YEAH STAY OUT OF MY WAY WEAKLING");
                        fightOn = false;
                        gameRunning = false;
                    }
                    else{
                        System.out.println("-You fail to flee the fight-");
                        System.out.println("Awww did you fail to run away from me");
                        System.out.printf("The %s attempts to hit you\n", monster.getName());
                        monsterAttackRoll = diceRoll.nextInt(6);
                        if(monsterAttackRoll <= 0){
                            System.out.printf("The %s failed to hit you\n", monster.getName());
    ...
    public static class CampfireFight {
        private static Scanner myinput = new Scanner(System.in);
        private static boolean life = true;
        private static boolean gameRunning = true;
