...
/**
 * creates an array list to sore items in the backpack
...
public class shopBackpack {
    ...
    /**
     * Main method which runs the programe
     */
...
//used to store and create items

    /**
     *creates an array list to store all items
     * @return
     *
     *
     */
...
/**
 allows for shop items to be viewed
 */
    public static void viewShopItems() {
        ...
        //is the loop for asking the user if they want to buy anything and if yes continue and stay in the loop if no ending the loop
        while (!myInput.equals(("n"))){
            System.out.println("would you like to purchase anything? yes or no?");
    ...
    /**
     purchaseItems is used to purchase items in the shop
     */
    ...
    /**
     viewBackpack is to show what is in the backpack
     */
